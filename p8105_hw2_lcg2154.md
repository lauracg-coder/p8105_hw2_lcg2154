...
set to include close, day, month, year in the columns. +
**unemployment** contains observations/variables modified to include
month, percentage of unemployment, year in the columns.

All three data sets were merged to create a set of the following
observations close, day, gov\_dem, gov\_gop, month, month\_name,
percentage of unemployment, president, rep\_dem, rep\_gop, sen\_dem,
sen\_gop, year, year.x, year.y as a final version.
